...
const Plans = () => {
    ...
    return (
        <section className="">
<div className=" px-5 py-20 bg-gradient-to-b from-black to-transparent">
            <div className="w-full border border-bronze bg-black/50 max-w-screen-xl mx-auto h-auto py-7 md:py-10">
                <div className="uppercase text-bronze font-bold flex-col py-30 px-5 md:px-10">
                ...
                <div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-12 px-5 py-5">
